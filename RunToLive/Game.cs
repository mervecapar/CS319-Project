...
namespace benimKodlar
{
    class Game
    {
        ...
        {
            return world.giveMePlayerInfectedProb();
        }
        ...
        public String giveNews()
        {
            ...
            int choose = RandomNumber(0, 2);

            if (day == 0 || day == 1)
                return "The World is under affect of a virus";
            else if (totalDied > 0 && day < 18)
                ...
                return "Sickness are seen all over the world";
            else if ((totalInfected * 100) / totalHealthy < 25 && (totalSicked * 100) / totalHealthy < 25 && choose == 0)
